...
As of 2026-09-16. Scenario: capital_low_20pct.

**Modeled break-even production cost: $9.59/kg SAF** ($7.67/L; $29.04/US gallon at assumed 0.8 kg/L).

Annual SAF: 100.0 kt; net annual cost: $958.9 million; installed capital: $7.72 billion.

Gross cost before coproducts/support: $10.15/kg. Net coproduct revenue: $56.1 million/year.

Conventional jet benchmark: $1.43/kg, observed 2026-09-09. Premium: $8.16/kg. This is a fossil-fuel spot benchmark, not a SAF market quote or a long-term price forecast.

Optimization: optimal; 8,784 hourly intervals; 211.8 seconds. Independent balance checks passed.
...
|---|---:|---|
| solar | 3,704,943.4 | kWdc |
| electrolyzer | 1,163,818.7 | kW |
| dac | 97,310.1 | kg_co2_per_hour |
| rwgs | 51,711.4 | kg_co_per_hour |
| ft | 24,624.5 | kg_syncrude_per_hour |
| upgrading | 15,267.2 | kg_saf_per_hour |
| h2_storage | 123,197.6 | kg_h2 |
| co2_storage | 128,659.2 | kg_co2 |
| battery_power | 609,170.3 | kW |
| battery_energy | 3,922,135.1 | kWh |
| heater | 253,746.4 | kWth |
